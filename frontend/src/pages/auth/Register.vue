          ...
          <form @submit.prevent="registerUser" class="mt-8 grid grid-cols-6 gap-6">
            <div class="col-span-12">
              ...
              <input v-model="formData.fullname" type="text" id="fullname"
                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-200"
                required />
            </div>
            ...
            <div class="col-span-12">
              <label for="PasswordConfirmation" class="block text-sm font-medium text-gray-200">
            ...
            <div class="col-span-12">
              <button type="submit"
                class="mt-4 w-full rounded-md bg-teal-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-teal-700 dark:bg-teal-700 dark:hover:bg-teal-800"
                :disabled="loading"> {{ loading ? "Mendaftarkan..." : "Daftar" }}
              </button>
            </div>
          </form>
